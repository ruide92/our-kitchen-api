...
const MENU_FIXTURE = {
  ...
  recipes: [
    ...
    { id: 'r-braised-ribs', kind: 'BASE', name: '红烧排骨', cover_image_url: null,
      ...
      suggested_kiss: 5, has_family_variant: true, family_variant_id: 'fr-braised-ribs',
      is_favorite: true, tags: ['硬菜', '宴客'] },
    ...
    { id: 'r-braised-pork', kind: 'BASE', name: '红烧肉', cover_image_url: null,
      ...
      suggested_kiss: 5, has_family_variant: true, family_variant_id: 'fr-braised-pork',
      is_favorite: true, tags: ['硬菜', '经典'] },
    ...
    { id: 'r-dumplings', kind: 'BASE', name: '手工饺子', cover_image_url: null,
      ...
      suggested_kiss: 4, has_family_variant: true, family_variant_id: 'fr-dumplings',
      is_favorite: true, tags: ['主食', '节日'] },
