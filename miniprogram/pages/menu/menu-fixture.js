...
const MENU_FIXTURE = {
  ...
  recipes: [
    { id: 'r-chili-pork', kind: 'BASE', name: '辣椒炒肉', cover_image_url: IMG.chiliPork,
      ...
      suggested_kiss: 4, has_family_variant: true, is_favorite: true, tags: ['下饭菜', '湘菜'] },
    ...
    { id: 'r-mapo-tofu', kind: 'BASE', name: '麻婆豆腐', cover_image_url: IMG.mapoTofu,
      ...
      suggested_kiss: 5, has_family_variant: true, is_favorite: true, tags: ['川菜', '下饭'] },
    ...
    { id: 'r-tomato-egg', kind: 'BASE', name: '番茄炒蛋', cover_image_url: null,
      ...
      suggested_kiss: 3, has_family_variant: true, is_favorite: true, tags: ['家常', '下饭'] },
    { id: 'r-braised-ribs', kind: 'BASE', name: '红烧排骨', cover_image_url: null,
      ...
      suggested_kiss: 5, has_family_variant: true, is_favorite: true, tags: ['硬菜', '宴客'] },
    ...
    { id: 'r-braised-pork', kind: 'BASE', name: '红烧肉', cover_image_url: null,
      ...
      suggested_kiss: 5, has_family_variant: true, is_favorite: true, tags: ['硬菜', '经典'] },
    ...
    { id: 'r-dumplings', kind: 'BASE', name: '手工饺子', cover_image_url: null,
      ...
      suggested_kiss: 4, has_family_variant: true, is_favorite: true, tags: ['主食', '节日'] },
  ],
  ...
  meals_by_date_and_type: {
    '2026-09-02': {
      ...
      DINNER: {
        items: [
          { id: 'mi-wed-d-1', recipe_id: 'r-chili-pork', recipe_name: '辣椒炒肉',
